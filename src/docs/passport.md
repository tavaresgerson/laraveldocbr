...
> [!NOTE]  
> If your application is primarily using Passport to issue personal access tokens, consider using [Laravel Sanctum](/docs/sanctum), Laravel's light-weight first-party library for issuing API access tokens.
